...
# Persistent=yes
    ...
    if [ "$Persistent" = "yes" ]
    then
        # Persistent mode assumes a 20 minute timeout before rsync will give up. (1200 seconds)
...
ArchiveDir=~/Downloads/LangTranArchive
    # The previous line says that the archive folder should be in your Downloads.
